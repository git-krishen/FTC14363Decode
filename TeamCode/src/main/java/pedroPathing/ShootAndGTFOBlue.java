...
@Autonomous(name = "ShootAndGTFOBlue", group = "Test")
public class ShootAndGTFOBlue extends OpMode {
    RobotHardware robot;
    ...
    private final Pose row1Start = new Pose(40, 6, Math.toRadians(270));
...
//    private final Pose scorePoseTop = new Pose(84, 60, Math.toRadians(135));
    private final Pose scorePose = new Pose(54, 12, Math.toRadians(298)); //y=18 // 240
